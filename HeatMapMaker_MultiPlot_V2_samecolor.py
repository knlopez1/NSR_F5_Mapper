...
map_file = "simple_21x169_10.07.2020_22.04.23_MAP"
...
hmx = sb.heatmap(Zarray, xticklabels=False, yticklabels=False, square=True, ax=ax[0], cbar=True, cbar_kws={'label':'pT'},)# cbar_ax=cbar_ax)
hmx.invert_xaxis()
hmy1 = sb.heatmap(Y1array, xticklabels=False, yticklabels=False, square=True, ax=ax[1], cbar_kws={'label':'pT'})# cbar_ax=cbar_ax)
hmy1.invert_xaxis()
hmz = sb.heatmap(Xarray, xticklabels=False, yticklabels=False, square=True, ax=ax[2], cbar_kws={'label':'pT'})# cbar_ax=cbar_ax)
hmz.invert_xaxis()
hmy2 = sb.heatmap(Y2array, xticklabels=False, yticklabels=False, square=True, ax=ax[3], cbar_kws={'label':'pT'})# cbar_ax=cbar_ax)
hmy2.invert_xaxis()

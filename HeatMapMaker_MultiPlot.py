...
hmx = sb.heatmap(Xarray, xticklabels=False, yticklabels=False, square=True, cbar_kws={'label':'pT'}, ax=ax[0])
hmx.invert_xaxis()
hmy1 = sb.heatmap(Y1array, xticklabels=False, yticklabels=False, square=True, cbar_kws={'label':'pT'}, ax=ax[1])
hmy1.invert_xaxis()
hmz = sb.heatmap(Zarray, xticklabels=False, yticklabels=False, square=True, cbar_kws={'label':'pT'}, ax=ax[2])
hmz.invert_xaxis()
